...
perl $RECOMBINEX_HOME/scripts/batch_tetrad_based_recombination_profiling_by_reference_genome.pl -s $master_sample_table -n $min_marker_number -l $min_block_size \
