...
##############################################################
#  script: batch_genotype_segregation_summarizing_by_reference_genome.pl
#  author: Jia-Xing Yue (GitHub ID: yjx1217)
#  last edited: 2019.09.23
#  description: run batch summarizing the genotype segregation ratio for called tetrad genotype
#  example: perl batch_genotype_segregation_summarizing_by_reference_genome.pl -s Master_Sample_Table.txt -genotype_dir genotype_dir -b batch_id -q qual_diff -output output.summary.txt
##############################################################
