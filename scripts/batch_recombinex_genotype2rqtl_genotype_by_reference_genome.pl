...
##############################################################
#  script: batch_recombinex_genotype2rqtl_genotype_by_reference_genome.pl
...
#  example: perl batch_recombinex_genotype2rqtl_genotype_by_reference_genome.pl -b Batch_S288C-SK1 -q 30 -g . -s Master_Sample_Table.S288C-SK1.txt
##############################################################
