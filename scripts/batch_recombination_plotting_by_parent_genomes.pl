...
##############################################################
#  script: batch_recombination_plotting_by_parent_genomes.pl
...
#  example: perl batch_recombination_plotting.pl -s master_sample_table --genome_dir genome_dir --genotype_dir genotype_dir --batch_id batch_id --recombination_profiling_dir recombination_profiling_dir -q 30 -o output_dir -c color_scheme --plot_centromere yes
##############################################################
...
GetOptions('sample_table|s:s' => \$sample_table, # master sample table
	   'genome_dir|genome_dir:s' => \$genome_dir, # the path to the 01.Parent_Genome_Preprocessing directory
