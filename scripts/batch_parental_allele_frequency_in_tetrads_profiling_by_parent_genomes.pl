...
#  example: perl batch_parental_allele_frequency_in_tetrads_profiling_by_parent_genomes.pl -s Master_Sample_Table.txt -batch_id batch_id -q 30 -m raw -output output.parental_allele_frequency.raw.txt.gz
##############################################################
