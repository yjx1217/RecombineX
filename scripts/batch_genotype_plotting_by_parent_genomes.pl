...
##############################################################
#  script: batch_genotype_plotting_by_parent_genomes.pl
#  author: Jia-Xing Yue (GitHub ID: yjx1217)
#  last edited: 2018.09.19
#  description: plot genotype for the tetrad
#  example: perl batch_genotype_plotting_by_parent_genomes.pl -s Master_Sample_Table.txt -m raw -genome_dir genome_dir -q 30 -genotype_dir genotype_dir -batch_id $batch_id -output_dir output_dir -color_scheme color_scheme -plot_centromere yes
##############################################################
