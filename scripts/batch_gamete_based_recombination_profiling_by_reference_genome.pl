...
##############################################################
#  script: batch_gamete_based_recombination_profiling_by_reference_genome.pl
#  author: Jia-Xing Yue (GitHub ID: yjx1217)
#  last edited: 2022.07.26
#  description: run batch recombination profiling to characterize different crossover and gene conversion events for random gametes
#  example: perl batch_gamete_based_recombination_profiling_by_reference_genome.pl -s Master_Sample_Table.txt -n 3 -l 100 -d 5000 -q 30 -b batch_id
##############################################################
