...
output_dir="$batch_id" # The output directory to create within this current directory. Default = "$batch_id".
...
perl $RECOMBINEX_HOME/scripts/batch_tetrad_based_recombination_profiling_by_parent_genomes.pl -s $master_sample_table -n $min_marker_number -l $min_block_size \
