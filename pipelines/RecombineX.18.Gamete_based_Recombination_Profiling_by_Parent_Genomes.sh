...
perl $RECOMBINEX_HOME/scripts/batch_gamete_based_recombination_profiling_by_parent_genomes.pl -s $master_sample_table -n $min_marker_number -l $min_block_size \
